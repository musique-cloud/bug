...
public class StringUtil {
     ...
     * @return
     */
    public static String getAfterDay(String pattern,Integer day) {
    ...
    public static String getPurchaseCode() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmssSS");
        return sdf.format(System.currentTimeMillis()) + "" + (int) (Math.random() * 9000 + 1000);
    }
    ...
    public static String phoneTo36String(String phone) {
        //转成36进制
        return Long.toString(new Long(phone), 36).toUpperCase();
    }
